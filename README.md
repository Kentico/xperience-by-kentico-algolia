...
> [!WARNING]  
> Version 27+ of Xperience by Kentico will be supported soon. ETA January 2024.
...
<a href="images/main-menu.png">
  <img src="images/main-menu.png" width="600" alt="Administration search index list">
</a>
...
1. Add this library to the application services, registering your custom `AlgoliaSearchModel`, using `builder.Services.AddAlgolia()`:
   ...
   {
       new AlgoliaIndex(typeof(MySearchModel), MySearchModel.IndexName)
   });
   ```
