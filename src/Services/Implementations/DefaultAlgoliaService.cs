...
[assembly: RegisterImplementation(typeof(IAlgoliaService), typeof(DefaultAlgoliaService), Lifestyle = Lifestyle.Singleton, Priority = RegistrationPriority.SystemDefault)]
namespace Kentico.Xperience.AlgoliaSearch.Services
{
    /// <summary>
    /// Default implementation of <see cref="IAlgoliaService"/>.
    /// </summary>
    internal class DefaultAlgoliaService : IAlgoliaService
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DefaultAlgoliaService"/> class.
        /// </summary>
        public DefaultAlgoliaService(ISearchClient searchClient, IAppSettingsService appSettingsService)
        {
