...
public partial class AlgoliaIncludedPathItemInfo : AbstractInfo<AlgoliaIncludedPathItemInfo, IInfoProvider<AlgoliaIncludedPathItemInfo>>
{
    ...
    public static readonly ObjectTypeInfo TYPEINFO = new(typeof(IInfoProvider<AlgoliaIncludedPathItemInfo>), OBJECT_TYPE, "KenticoAlgolia.AlgoliaIncludedPathItem", nameof(AlgoliaIncludedPathItemId), null, nameof(AlgoliaIncludedPathItemGuid), null, null, null, null, null)
    {
        ...
        {
            new(nameof(AlgoliaIncludedPathItemIndexItemId), AlgoliaIndexItemInfo.OBJECT_TYPE, ObjectDependencyEnum.Required),
        },
    ...
    /// </summary>
    [DatabaseField]
    public virtual string AlgoliaIncludedPathItemAliasPath
    {
        get => ValidationHelper.GetString(GetValue(nameof(AlgoliaIncludedPathItemAliasPath)), String.Empty);
        set => SetValue(nameof(AlgoliaIncludedPathItemAliasPath), value);
    }
    ...
    /// </summary>
    [DatabaseField]
    public virtual int AlgoliaIncludedPathItemIndexItemId
    {
        get => ValidationHelper.GetInteger(GetValue(nameof(AlgoliaIncludedPathItemIndexItemId)), 0);
        set => SetValue(nameof(AlgoliaIncludedPathItemIndexItemId), value);
    }
